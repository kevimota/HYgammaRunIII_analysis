...
datasets = {
    "Data": [
        "output/mc_data_comp/MuonEG_Run2024C.pkl",
        "output/mc_data_comp/MuonEG_Run2024D.pkl",
        "output/mc_data_comp/MuonEG_Run2024E.pkl",
        "output/mc_data_comp/MuonEG_Run2024F.pkl",
        "output/mc_data_comp/MuonEG_Run2024G.pkl",
        "output/mc_data_comp/MuonEG_Run2024H.pkl",
        "output/mc_data_comp/MuonEG_Run2024I.pkl",
        "output/mc_data_comp/MuonEG_Run2024I-v2.pkl",
    ],
    "ggH": [
        "output/mc_data_comp/GluGluToH_HToUps1SG_Ups1SToMuMu.pkl",
        "output/mc_data_comp/GluGluToH_HToUps2SG_Ups2SToMuMu.pkl",
        "output/mc_data_comp/GluGluToH_HToUps3SG_Ups3SToMuMu.pkl",
    ],
    "VBF": [
        "output/mc_data_comp/VBFToH_HToUps1SG_Ups1SToMuMu.pkl",
        "output/mc_data_comp/VBFToH_HToUps2SG_Ups2SToMuMu.pkl",
        "output/mc_data_comp/VBFToH_HToUps3SG_Ups3SToMuMu.pkl",
    ],
    "WH": [
        "output/mc_data_comp/WH_HToUps1SG_Ups1SToMuMu.pkl",
        "output/mc_data_comp/WH_HToUps2SG_Ups2SToMuMu.pkl",
        "output/mc_data_comp/WH_HToUps3SG_Ups3SToMuMu.pkl",
    ],
    "ZH": [
        "output/mc_data_comp/ZH_HToUps1SG_Ups1SToMuMu.pkl",
        "output/mc_data_comp/ZH_HToUps2SG_Ups2SToMuMu.pkl",
        "output/mc_data_comp/ZH_HToUps3SG_Ups3SToMuMu.pkl",
    ],
    "bbH": [
        "output/mc_data_comp/bbH_HToUps1SG_Ups1SToMuMu.pkl",
        "output/mc_data_comp/bbH_HToUps2SG_Ups2SToMuMu.pkl",
        "output/mc_data_comp/bbH_HToUps3SG_Ups3SToMuMu.pkl",
    ],
    "ttH": [
        "output/mc_data_comp/ttH_HToUps1SG_Ups1SToMuMu.pkl",
        "output/mc_data_comp/ttH_HToUps2SG_Ups2SToMuMu.pkl",
        "output/mc_data_comp/ttH_HToUps3SG_Ups3SToMuMu.pkl",
    ],
    "qqZ": [
        "output/mc_data_comp/ZToUps1SG_Ups1SToMuMu.pkl",
        "output/mc_data_comp/ZToUps2SG_Ups2SToMuMu.pkl",
        "output/mc_data_comp/ZToUps3SG_Ups3SToMuMu.pkl",
    ],
    "HtoMuMuG": ["output/mc_data_comp/ggH125_012j_NLO_FXFX_HtoMuMuGamma.pkl"],
    "ZGTo2MuG": ["output/mc_data_comp/ZGTo2MuG_mll_2to15_LO.pkl"],
}
